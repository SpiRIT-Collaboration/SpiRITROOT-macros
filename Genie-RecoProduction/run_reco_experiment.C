...
(
 ...
 TString fSupplePath = "/mnt/spirit/rawdata/misc/rawdataSupplement" // NSCL/HPCC
// TString fSupplePath = "/gwdata/G17033/rawdataSupplement" // RIKEN/HOKUSAI
)
{
...
//    decoder -> SetGainCalibrationData(fGCData);
  ...
  psa -> SetLayerCut(-1, 112); // To use all the layer, you need magnetic field with only By and 25cm shift to the upstream
//  psa -> SetLayerCut(-1, 90); // With full magnetic field map without shifting anything
...
//  genfitPID -> SetConstantField(); // If you comment out this line, magnetic field map file is used.
